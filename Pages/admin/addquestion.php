    ...
    <form action="">
        <div class="row justify-content-center m-3">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" placeholder="Crrect Answer">
            </div>
            <div class="input-group mb-3">
                <label for="" class="input-group-text">Time limit</label>
                <input type="text" class="form-control" placeholder="Time limit">
            </div>
            <div class="input-group mb-3">
            ...
            <div class="input-group mb-3">
                ...
                <select name="" id="chooseCatagory" class="form-select">
                    ...
                    <option value="">Multichoose</option>
                    <option value="">Ture / False</option>
                </select>
            </div>
